...
public class TimeFunctions {
    ...
    /**
     * @param date,time takes date and time inputs and combines them to return combinedDateTime
    ...
    /**
     * @param date,time takes date and time inputs and combines them to return combinedDateTime in UTC.
    ...
    /**
     * @param dateTime takes date and time inputs and converts to UTC timezone
    ...
    /**
     * @param dateTime takes date and time inputs and converts to local system timezone
    ...
    /**
     * @param start,end takes in a start and end time, then gets all appointment dates and times from the appointments table
